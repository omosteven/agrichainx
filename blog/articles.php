...
<title>Agrichainx | Blog-Our Articles</title>
...
<br><br>
<center>
<h1>Be the first to get the article!</h1> <br>

<form class="" action="index.html" method="post">
<input type="text" name=""  style="height:60px" value="" placeholder="Enter Your Email"><br>
<input  type="button" width="30%"class="button" name="" style="  "value="subscribe" width="30%">
</form>
...
<br>
          ...
          <div class="container">
            ...
            <section>
            <br><br> <center>  <h1>ARTICLE</h1> <center> <br><br>
            </section>
          

            <center><h1></h1></center>
            <?php
            $fetchPost = mysqli_query($db,"SELECT * FROM blogpost WHERE PERMISSION = 1 and TYPE = 'article' ORDER BY id DESC");
            while($post = mysqli_fetch_array($fetchPost)){
              ...
              echo "<p>$text</p>
              <!--form action ='read.php?article=$post[URL]' method='GET' name='readmore'>
              ...
              <a href ='read.php?Article=$post[URL]' name='read' class='button' style='background-color:#4CAF50; margin: 10px 0;  border-color:#4CAF50;float:right; font-size:18px;' type='button'>Read More</a>
              </div>";
            }
            ?>
