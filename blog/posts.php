...
<head>
  ...
  <title>Agrichainx | All Posts</title>
  ...
  <main style="z-index:-1; ">
    ...
    <section class="section-3">
      <div class="container">
        ...
        <?php
            $fetchPost = mysqli_query($db,"SELECT * FROM blogpost");
            while($post = mysqli_fetch_array($fetchPost)){
              ...
              echo "<p>$text</p>
              <!--form action ='read.php?$post[TYPE]=$post[URL]' method='GET' name='readmore'>
              ...
              <a href ='adminread.php?$post[TYPE]=$post[URL]' name='read' class='button' style='background-color:#4CAF50; margin: 10px 0;  border-color:#4CAF50;float:right; font-size:18px;' type='button'>Read More</a>
              </div>";
            }
            ?>
